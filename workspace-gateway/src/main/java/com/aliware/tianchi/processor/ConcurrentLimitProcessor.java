...
public class ConcurrentLimitProcessor {
    ...
    private static final double[] GAIN_VALUES = {1.1, 0.9, 1, 1, 1, 1};
    ...
    private class Leaking implements Runnable {
        ...
        public void run() {
            ...
            scheduledExecutorService.schedule(this, (long) (6D * RTPropEstimated), TimeUnit.MILLISECONDS);
